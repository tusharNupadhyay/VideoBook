...
//optional JWT middleware for routes that are public but perform some action if user is logged in ,e.g. getVideoById is a public route which fetches video by id but if user is logged in then it also adds a view and push the video to user's watch history
